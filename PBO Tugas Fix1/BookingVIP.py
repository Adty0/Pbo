class BookingVIP:
    def __init__(self):
        ...
        if(self.lamasewa == "1"):
            ...
            print("Total sewa 1 Jam: Rp.15.000")
            print("Ruangan VIP")
            print("  ")
            ...
            print("Alamat Penyewa : %s" % (self.alamat))
            print("Nomor Telepon Penyewa : %s" % (self.nomorTelepon))
            print("Total sewa 2 Jam: Rp.30.000")
            print("Ruangan VIP")
            print("  ")
            print("Silahkan melakukan pembayaran sekarang")
            print("======================================")
            ...
            print("Alamat Penyewa : %s" % (self.alamat))
            print("Nomor Telepon Penyewa : %s" % (self.nomorTelepon))
            print("Total sewa 3 Jam: Rp.45.000")
            print("Ruangan VIP")
            print("  ")
            print("Silahkan melakukan pembayaran sekarang")
            print("======================================")
            ...
            print("Alamat Penyewa : %s" % (self.alamat))
            print("Nomor Telepon Penyewa : %s" % (self.nomorTelepon))
            print("Total sewa 4 Jam: Rp.60.000")
            print("Ruangan VIP")
            print("  ")
            print("Silahkan melakukan pembayaran sekarang")
            print("======================================")
            ...
            print("Alamat Penyewa : %s" % (self.alamat))
            print("Nomor Telepon Penyewa : %s" % (self.nomorTelepon))
            print("Total sewa 5 Jam: Rp.75.000")
            print("Ruangan VIP")
            print("  ")
            print("Silahkan melakukan pembayaran sekarang")
            print("======================================")
